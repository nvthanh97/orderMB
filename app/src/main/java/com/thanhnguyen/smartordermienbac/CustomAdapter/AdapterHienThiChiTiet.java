...
public class AdapterHienThiChiTiet extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            ...
            if (String.valueOf(baiDangDTOList.get(position).getBanonline())=="true")
            {
                viewHolderNhanVien.giatien.setText("QR- code order");
            }
           else {
                viewHolderNhanVien.giatien.setText("Gọi món tại nhà hàng");
            }
