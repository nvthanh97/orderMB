...
import com.thanhnguyen.smartordermienbac.CustomAdapter.Custom_Adapter_LH;
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            if (response.trim().equals("true")){
                                new AlertDialog.Builder(ThemThucDonActivity.this)
                                        .setTitle("Xong!")
                                        ...
                                        .setNegativeButton("Xong", new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent i= new Intent(ThemThucDonActivity.this, home.class);
                                        ...
                                        .setPositiveButton("Thêm tiếp", new DialogInterface.OnClickListener()
                                        {
                                            ...
                                            {
                                                Intent i= new Intent(ThemThucDonActivity.this, ThemThucDonActivity.class);
                                                startActivity(i);
                                            }
                                        })
                                        .setNegativeButton("Định lượng", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent i= new Intent(ThemThucDonActivity.this, ThemThucDonActivity.class);
