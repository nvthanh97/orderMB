...
public class DangBai extends AppCompatActivity implements View.OnClickListener{
    ...
    String url= config.domain +"android/thembaidangmienbac.php";
            ...
            switch (id){
                ...
                case R.id.ti1:
                    if (wc==false)
                    {
                        ...
                        wc=true;
                        Toast.makeText(this, "Gọi món nằng mã QR code (Dự định sẽ setup)", Toast.LENGTH_SHORT).show();
                        break;
                    }
                    if( wc==true)
                    {
                        ...
                        wc=false;
                        Toast.makeText(this, "Gọi món truyền thống", Toast.LENGTH_SHORT).show();
                        break;
                    }
