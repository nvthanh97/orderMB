...
import com.thanhnguyen.smartordermienbac.CustomAdapter.AdapterInHoaDon;
import com.thanhnguyen.smartordermienbac.DTO.ThanhToanDTO;
import com.thanhnguyen.smartordermienbac.DTO.VNCharacterUtils;
            ...
            public void run() {
                try {
                    ...
                    for ( int i=0; i< listBA.size(); i++)
                    {
                        ...
                        String str1 = en.format(longNumber);
                        ds+=VNCharacterUtils.removeAccent(listBA.get(i).getTenMonAn())+ "        "+ str1+"  " +listBA.get(i).getSoLuong() + "\n";

                    }
                    vio = ds+"\n";
                    vio = vio
                            + "--------------------------------\n";
                    mvdtail = "     "+ VNCharacterUtils.removeAccent(twtt.getText().toString())+"\n";
                    mvdtail = mvdtail
                            + "================================\n";
